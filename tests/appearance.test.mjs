...
test('frameless windows, persistent synchronized themes, live system scheme and reduced motion', async () => {
  ...
  try {
    ...
    await waitFor(page, () => getComputedStyle(document.body).backgroundColor === 'rgb(16, 19, 26)')
    ...
    await waitFor(usage, () => getComputedStyle(document.body).backgroundColor === 'rgb(16, 19, 26)')
    ...
    await waitFor(page, () => getComputedStyle(document.body).backgroundColor === 'rgb(243, 245, 248)')
    await waitFor(usage, () => getComputedStyle(document.body).backgroundColor === 'rgb(243, 245, 248)')
