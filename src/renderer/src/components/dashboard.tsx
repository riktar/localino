    ...
    <div className="grid min-w-0 gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
      <div className="min-w-0 space-y-6">
        {!connected ? <Card><CardContent className="text-sm text-muted-foreground">Collega Codex per leggere le statistiche dell'account.</CardContent></Card> : <>
          ...
          <p className="text-xs leading-relaxed text-muted-foreground">Statistiche aggiornate ogni 5 minuti mentre questa finestra è aperta. I token riguardano l'account: non misurano costi, produttività o il solo lavoro svolto in Localino. Nessuna cronologia salvata sul PC.</p>
        </>}
      </div>
